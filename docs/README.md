...
This directory contains documentation for the Socratic Tutor Evaluation Framework.
...
The research paper describing the evaluation framework and metrics is in `Socratic_Tutor.pdf` at the project root.
